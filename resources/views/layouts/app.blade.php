            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li>
                            <a class="btn btn-sm @if(Request::is('dashboard')) btn-primary @else btn-secondary @endif" href="/dashboard">Data</a>
                        </li>
                        <li>
                            <a class="btn btn-sm @if(Request::is('dashboard-analysis')) btn-primary @else btn-secondary @endif" href="/dashboard-analysis">Analysis</a>
                        </li>
                    </ul>
